var imgAdrs = window.location.pathname + 'common/tiles'///地图瓦片地址
var imgType='.png';//地图瓦片类型。（png/jpg）
window.TILE_VERSION = {
  "ditu": {
      "normal": {
          "version": "088",
...
window.BMAP_AUTHENTIC_KEY = "klj6ikA7um96cu50PD52Wqb7WKo2Z5ji"; (function() {
  function ba(a) {
      throw a;
  }
  var l = void 0,
  ...
  A.lang.Ja.prototype.addEventListener = function(a, b, c) {
      if (A.lang.wt(b)) { ! b.nl && (b.nl = {}); ! this.Li && (this.Li = {});
          var e = this.Li,
          f;
  ...
  A.lang.Ja.prototype.removeEventListener = function(a, b) {
      ...
      if (A.lang.wt(b)) {
          ...
          b = b.nl[a].Dx
      } else if (!A.lang.Eg(b)) return; ! this.Li && (this.Li = {});
      var c = this.Li;
      c[a] && c[a][b] && delete c[a][b]
  };
  A.lang.Ja.prototype.dispatchEvent = function(a, b) {
      A.lang.Eg(a) && (a = new A.lang.Iu(a)); ! this.Li && (this.Li = {});
      var b = b || {},
      c;
      for (c in b) a[c] = b[c];
      var e = this.Li,
  ...
  D.V0 = D.verify ||
  function() {
      D.version && D.version >= 1.5 && qa(D.td + "?qt=verify&ak=" + ra,
      function(a) {
          if (a && a.error !== 0) {
      ...
      a.addEventListener ? a.addEventListener("load",
      function(a) {
          a = a.target;
          a.parentNode.removeChild(a)
      },
      t) : a.attachEvent && a.attachEvent("onreadystatechange",
      function() {
  ...
  A.extend(Oa.prototype, {
      ...
      zi: function(a) {
          if (a instanceof Q || a instanceof L) a = $a(a, this.M.Ma),
          this.Vb = this.Fc.ri(a, this.Ob),
          this.he = Q.lE(a) ? new L(a.lng, a.lat) : this.Fc.xh(this.Vb, this.Ob)
      },
      Kg: function(a, b) {
          a = Math.round(a) || 0;
          b = Math.round(b) || 0;
      ...
      Og: function(a) {
          if (this.Ua !== a) {
              ...
              b.Ua = a;
              this.dispatchEvent(b);
              a.rF(this.M.Ma); (a === cb || a === Ua) && Ta(Ba)
          }
      },
      C_: function(a) {
          ...
          if (db(a)) if (c.Ua === Sa) {
              ...
              f.eu(function(e) {
                  if (0 === f.Em() && (2 === f.Ka.result.type || 11 === f.Ka.result.type)) {
                      var g = e.Ik(0).point,
                      e = b || fb.ix(f.Ka.content.level, c),
                      g = new L(g.lng, g.lat);
                      c.ud(g, e);
                      Sa.Ck(a) && c.kF(a)
                  }
      ...
      ap: function() {
          this.M.ap = p;
          this.Mn || (this.Mn = new BuildingLayer({
              m3: p
          }), this.Ue(this.Mn))
      },
      hW: function() {
      ...
      ht: function(a, b) {
          ...
          return {
              center: eb(new L(c.lng, c.lat), this.M.Ma),
              zoom: f
          }
      },
      Pg: function(a, b) {
      ...
      eM: function(a) {
          a ? this.ys && this.ys.If === a || (this.cg(this.ys), this.ys = new sb({
              geotableId: a
          }), this.Ue(this.ys)) : this.cg(this.ys)
      },
      Vd: function() {
          var a = this.la() >= this.M.TF && this.ya() === Pa && 18 >= this.la(),
          b = t;
          try {
      ...
      EF: function(a, b) {
          ...
          k; k = a[i]; i++) if (!this.NY(k)) {
              ...
              A.extend(m, k);
              k = [];
              for (var n in e) if (m[n] && !this.JY(n)) if ("elementType" === n) k.push(e[n] + ":" + f[m[n]]);
              else {
                  switch (m[n]) {
                  case "poilabel":
                      m[n] = "poi";
  ...
  D.mi = function(a, b) {
      ...
      default:
          e = D.url.domain[a],
          "[object Array]" == Object.prototype.toString.call(e) ? (c = [], A.oc.Pb(e,
          function(a, e) {
              c[e] = D.url.proto + a + "/" + b
  ...
  yb.prototype.stop = function(a) {
      this.FF = p;
      for (var b = 0; b < this.fg.length; b++) this.fg[b].stop(),
      this.fg[b] = q;
      this.fg.length = 0;
  ...
  function Pb(a) {
      ...
      do c = Nb.indexOf(a.charAt(k++)),
      e = Nb.indexOf(a.charAt(k++)),
      g = Nb.indexOf(a.charAt(k++)),
      i = Nb.indexOf(a.charAt(k++)),
      c = c << 2 | e >> 4,
      e = (e & 15) << 4 | g >> 2,
      f = (g & 3) << 6 | i,
  ...
  function(a, b, c) {
      ...
      function(a, b, c) {
          function i(a) {
              if (!a.Xo) {
                  for (var c = p,
                  e = [], g = a.c_, k = 0; g && k < g.length; k++) {
                      var m = g[k],
                      n = da[m] = da[m] || {};
                      if (n.Xo || n == a) e.push(n.Tc);
                      else {
                          c = t;
          ...
          if (!B || !B.Xo) {
              ...
              E = B && B.uE || +new Date,
              F = a.S4 || ( + new Date).toString(36) + Math.random().toString(36).substr(2, 3),
              G = 0,
              K = {},
              O = function(a) {
                  var b = arguments,
      ...
      function(a, b, c) {
          ...
          s && (s.Ch && m() < s.Ch) && (c.alog("cus.on", "time",
          function(a) {
              var b = {},
              e = t,
              f;
          ...
          if (v && v.Ch && m() < v.Ch) {
              ...
              tj = function() {
                  return "Promise" in a && "cast" in a.xq && "resolve" in a.xq && "reject" in a.xq && "all" in a.xq && "race" in a.xq &&
                  function() {
                      var b;
                      new a.xq(function(a) {
                          b = a
  ...
  function uc(a) {
      ...
      m = o.lng,
      o = o.lat;
      if (1.0E-6 >= xc(m, o, i, k)) return c.lng = e,
      c.lat = f,
      c;
      for (;;) {
          m = e - g;
  ...
  function vc(a) {
      var b = {};
      if (a.lng < Wb[0] - 0.4 || a.lat < Wb[1] - 0.4 || a.lng > Wb[2] + 0.4 || a.lat > Wb[3] + 0.4) return b.lng = a.lng,
      b.lat = a.lat,
      b;
      ...
      f = new yc,
      g = 0,
      e = 0; e < ac; ++e) dc[e] <= a.lat ? dc[(e + 1) % ac] > a.lat && 0 < Bc({
          lng: cc[e],
          lat: dc[e]
      },
      {
      ...
      if ((0 === g ? nc: oc) === nc) {
          for (g = 0; g < ac; ++g) if (e = new zc(cc[g], dc[g], cc[(g + 1) % ac], dc[(g + 1) % ac]), f.Gg.lng = e.$x.Gg.lng - 0.5, f.Gg.lat = e.$x.Gg.lat - 0.5, f.Ng.lng = e.$x.Ng.lng + 0.5, f.Ng.lat = e.$x.Ng.lat + 0.5, f.contains(a) !== nc) {
              ...
              o = e.ex.lat;
              i = o - m;
              var s = k - n; ! (Math.abs(i - 0) > pc) && !(Math.abs(s - 0) > pc) ? i = e.mu: (k = n * m - k * o, m = s * a.lng - i * a.lat, n = i * i - s * s, i = {
                  lng: (s * m - i * k) / n,
                  lat: -(i * m + s * k) / n
              });
              s = 180;
  ...
  function Cc(a) {
      var b = {};
      if (a.lng < Xb[0] - 0.4 || a.lat < Xb[1] - 0.4 || a.lng > Xb[2] + 0.4 || a.lat > Xb[3] + 0.4) return b.lng = a.lng,
      b.lat = a.lat,
      b;
      if (sc(a, Zb, $b)) {
          var b = a.lng - kc,
  ...
  function qa(a, b) {
      if (/^http/.test(a))//这里判断一下，如果是调用外部资源就退出去好了
          return true;
      // try {
      //   if(a.__proto__.constructor.name==='Promise') return
      // } catch (error) {}
      if (b) {
  ...
  A.object.extend(Wa, {
          ...
          if (e.Se == this.Mj.pq) c && b();
              ...
              if (e.Se == this.Mj.uG) {
                  ...
                  f.BC == t && (f.BC = p, setTimeout(function() {
                      ...
                      // console.log(a);     //这里很重要！帮助我们找到我们需要加载的模块！但是我选择的是所有模块
                      // 0 == a.length ? f.WK() : qa(import("./getmodules2.js")) 报错原因是传入qa函数的是Promise
                      0 == a.length ? f.WK() : import("./getmodules2.js")
                  },
                  1));
                  e.Se = this.Mj.MP
              }
      ...
      nK: function(a) {
          if (a && this.pL()[a]) for (var a = this.pL()[a], b = 0; b < a.length; b++) this.nK(a[b]),
          this.Xd.El[a[b]] || this.zN(a[b])
      },
      zN: function(a) {
      ...
      qb: function(a) {
          this.Xd.El[a] || (this.Xd.El[a] = {},
          this.Xd.El[a].Se = this.Mj.uG, this.Xd.El[a].Xu = []);
          return this.Xd.El[a]
      },
      remove: function(a) {
          delete this.qb(a)
      ...
      rV: function(a, b) {
          for (var c = this.Xd.bw,
          e = p,
          f = 0,
          g = c.length; f < g; f++)"" == c[f].IE && (c[f].RM == a ? c[f].IE = b: e = t);
          e && this.WK()
      },
      WK: function() {
          for (var a = this.Xd.bw,
          b = 0,
          c = a.length; b < c; b++) this.g_(a[b].RM, a[b].IE);
          this.Xd.bw.length = 0
      }
  });
  function R(a, b) {
  ...
  function mb(a, b) {
      a && (this.Mb = a, this.da = "spot" + mb.da++, b = b || {},
      this.ih = b.text || "", this.Iv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.IB = b.userData || q, this.Qh = b.minZoom || q, this.Nf = b.maxZoom || q)
  }
  mb.da = 0;
  ...
  A.extend(Ec.prototype, {
      initialize: function(a) {
          this.P = a;
          if (this.R) return a.cb.appendChild(this.R),
          this.R
      },
      Me: function(a) { ! this.R && (this.initialize && bb(this.initialize)) && (this.R = this.initialize(a));
          this.m = this.m || {
              Mg: t
          };
          this.wB();
  ...
  A.object.extend(Jc.prototype, {
      ...
      xm: function(a) {
          for (var b = 0,
          c = this.gc.length; b < c; b++) if (this.gc[b].id == a) return this.gc[b]
      },
      CD: x("gc"),
      XE: function(a) {
          for (var b = 0,
          c = this.gc.length; b < c; b++) this.gc[b].id == a && (r = this.gc.splice(b, 1), b--, c = this.gc.length)
      },
      Ef: function() {
          var a = this;
          Wa.load("copyrightctrl",
          function() {
              a.Df()
          })
      }
  ...
  A.object.extend(Pc.prototype, {
      ...
      $E: function(a) {
          if (this.Ke[a]) {
              for (var b = 0,
              c = this.Da.length; b < c; b++) this.Da[b] && ("divider" == this.Da[b].Nb && this.Da[b].Uj == a) && (this.Da.splice(b, 1), c--),
              this.Da[b] && ("divider" == this.Da[b].Nb && this.Da[b].Uj > a) && this.Da[b].Uj--;
              this.Ke.splice(a, 1)
          }
      },
      cd: x("R"),
  ...
  var Qc = I.ua + "menu_zoom_in.png",
  Rc = I.ua + "menu_zoom_out.png";
  function Sc(a, b, c) {
      if (a && bb(b)) {
          A.lang.Ja.call(this);
          this.m = {
  ...
  A.extend(T.prototype, {
      ...
      vc: function(a, b, c, e, f) {
          if (a) return a = this.ri(a, f),
          b = this.$b(b),
          new R(Math.round((a.lng - c.lng) / b + e.width / 2), Math.round((c.lat - a.lat) / b + e.height / 2))
      },
      gZ: function(a, b, c, e) {
          if (a) return b = this.$b(b),
          new R(Math.round((a.lng - c.lng) / b + e.width / 2), Math.round((c.lat - a.lat) / b + e.height / 2))
      },
      bc: function(a, b, c, e, f) {
          if (a) return b = this.$b(b),
          this.xh(new L(c.lng + b * (a.x - e.width / 2), c.lat - b * (a.y - e.height / 2)), f)
      },
      $b: function(a) {
  ...
  D.df(function(a) {
      ...
      function(a) {
          a = a.target;
          if (a instanceof kb) b.ta[a.da] || (b.ta[a.da] = a);
          else {
              for (var e = t,
              f = 0,
              g = b.Je.length; f < g; f++) if (b.Je[f] === a) {
                  e = p;
                  break
              }
              e || b.Je.push(a)
      ...
      function(a) {
          a = a.target;
          if (a instanceof kb) delete b.ta[a.da];
          else for (var e = 0,
          f = b.Je.length; e < f; e++) if (b.Je[e] === a) {
              b.Je.splice(e, 1);
              break
          }
      });
  ...
  A.extend(Zc.prototype, {
      ...
      uX: function() {
          for (var a = [], b = 0; b < this.ja.length - 1; b++) var c = this.kV(this.ja[b], this.ja[b + 1]),
          a = a.concat(c);
  ...
  A.extend($c.prototype, {
      ...
      initialize: function(a) {
          this.map = a;
          this.Oj();
          this.ca && A.V(this.ca, J() ? "touchstart": "mousedown",
          function(a) {
              na(a)
          });
          return this.ca
  ...
  function cd(a, b, c, e) {
      a && (this.Nv = {},
      this.$K = e ? !!e: t, this.$c = [], this.f0 = a instanceof bd ? a: q, this.EI = b === l ? p: !!(b.indexOf("%") + 1), this.jk = isNaN(parseFloat(b)) ? 1 : this.EI ? parseFloat(b) / 100 : parseFloat(b), this.FI = !!(c.indexOf("%") + 1), this.repeat = c != l ? this.FI ? parseFloat(c) / 100 : parseFloat(c) : 0)
  };
  function dd(a, b) {
      A.lang.Ja.call(this);
      this.content = a;
  ...
  A.extend(dd.prototype, {
      ...
      YN: function(a) { ! a && 0 != a || (isNaN(a) || 0 > a) || (0 != a && (220 > a && (a = 220), 730 < a && (a = 730)), this.K.maxWidth = a)
      },
      Hc: function(a) {
          this.K.title = a
      },
  ...
  function jd(a, b) {
      var c = this;
      id() && (a === l && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {},
      kb.apply(c, arguments), c.ia = {
          ja: a
      },
      c.K = {
          shape: b.shape || gd,
      ...
      this.fB = [], this.ue = [], Wa.load("pointcollection",
      function() {
          for (var a = 0,
  ...
  ld = new ad(I.ua + "marker_red_sprite.png", new N(20, 11), {
      anchor: new N(6, 11),
  ...
  md.prototype.initialize = function(a) {
      ...
      c = this.canvas.getContext(this.HV);
  ...
  function od(a) {
      var b = (window.devicePixelRatio || 1) / (a.UU || a.F6 || a.c5 || a.d5 || a.h5 || a.UU || 1),
      c = a.canvas.width,
      e = a.canvas.height;
      a.canvas.width = c * b;
      a.canvas.height = e * b;
  ...
  A.extend(td.prototype, {
      ...
      Fp: function() {
          ...
          this.loaded || a.Lx();
          a.ag();
          this.loaded || (this.loaded = p, Wa.load("tile",
          function() {
              a.WP()
          }))
      },
      ...
      KL: function(a, b, c) {
          ...
          n = 0;
          for (e = this.Ve.length; n < e; n++) s = this.Ve[n],
          s.mr || this.We.push(s);
          this.IF = [];
          y = (f + c) * this.map.M.devicePixelRatio;
          n = 0;
          for (e = this.Ie.length; n < e; n++) C = this.Ie[n][0],
          k = this.Ie[n][1],
          v = C * f + i[0] - c / 2,
          w = ( - 1 - k) * f + i[1] - c / 2,
          z = m + "_" + b + "_" + C + "_" + k + "_" + g,
          o = this.Tm[z],
          s = q,
          o ? (s = o.style, s.left = v + "px", s.top = w + "px", o.Tn || this.IF.push([C, k, o])) : (0 < this.We.length ? (o = this.We.shift(), o.getContext("2d").clearRect( - c / 2, -c / 2, y, y), s = o.style) : (o = document.createElement("canvas"), s = o.style, s.position = "absolute", s.width = f + c + "px", s.height = f + c + "px", this.RY() && (s.WebkitTransform = "scale(1.001)"), o.setAttribute("width", y), o.setAttribute("height", y), a.appendChild(o)), o.id = z, s.left = v + "px", s.top = w + "px", -1 < z.indexOf("bg") && (v = "#F3F1EC", this.map.M.SU && (v = this.map.M.SU), s.background = v ? v: ""), this.IF.push([C, k, o])),
          o.style.visibility = "";
          n = 0;
      ...
      U_: function(a, b, c, e) {
          ...
          m && m.Hb ? (Cb(m.Hb, b), e && (e = new R(a[0], a[1]), g = this.map.M.De ? this.map.M.De.style: "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, yd(m, e)), m.loaded ? this.Ff() : zd(m,
          function() {
              f.Ff()
          })) : (m = this.jj[i]) && m.Hb ? (c.Kb.insertBefore(m.Hb, c.Kb.lastChild), this.Ig[i] = m, Cb(m.Hb, b), e && (e = new R(a[0], a[1]), g = this.map.M.De ? this.map.M.De.style: "normal", e = c.getTilesUrl(e, a[2], g), m.loaded = t, yd(m, e)), m.loaded ? this.Ff() : zd(m,
          function() {
              f.Ff()
          })) : (m = k * Math.pow(2, g.Ze() - a[2]), new L(a[0] * m, a[1] * m), e = new R(a[0], a[1]), g = this.map.M.De ? this.map.M.De.style: "normal", e = c.getTilesUrl(e, a[2], g), m = new Ad(this, e, b, a, c), zd(m,
          function() {
              f.Ff()
          }), m.eo(), this.Ig[i] = m)
      },
      ...
      ag: function(a) {
          if (!this.map.M.yg) {
              var b = this;
              if (b.map.ya() == Sa) Wa.load("coordtrans",
              function() {
      ...
      kI: function(a) {
          ...
          for (var k = 0; k < c; k++) {
              ...
              if (!m.b2 && !(m.Rx && !this.map.Vd() || m.nM && this.map.Vd())) {
                  ...
                  for (E in C) {
                      var F = C[E],
                      G = F.info; (G[2] != w || G[2] == w && (v > G[0] || y <= G[0] || o > G[1] || f <= G[1])) && this.Hx(F)
                  }
                  ...
                  z = [];
                  for (e.KB = []; v < y; v++) for (B = o; B < f; B++) z.push([v, B]),
                  e.KB.push({
                      x: v,
                      y: B
                  });
      ...
      cg: function(a) {
          ...
          if (a.Rx) for (var b = 0,
          c = this.Qg.length; b < c; b++) a == this.Qg[b] && this.Qg.splice(b, 1);
          else {
              b = 0;
      ...
      bu: function(a) {
          var b = this.map.ya();
          if (!this.map.Vd() && (a ? this.map.M.c0 = a: a = this.map.M.c0, a)) for (var c = q,
          c = "2" == D.Au ? [D.url.proto + D.url.domain.main_domain_cdn.other[0] + "/"] : [D.url.proto + D.url.domain.main_domain_cdn.baidu[0] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[1] + "/", D.url.proto + D.url.domain.main_domain_cdn.baidu[2] + "/"], e = 0, f; f = this.Cj[e]; e++) if (f.P_ == p) {
              b.m.qc = 18;
  ...
  Dd.prototype.getTilesUrl = function(a, b) {
      ...
      var c = this.sU + c + "level=" + b + "&x=" + a.x + "&y=" + a.y,
      e = 1;
      this.P.Ix() && (e = 2);
  ...
  Fd = D.url.proto + D.url.domain.main_domain_nocdn.baidu + "/style/poi/rangestyle",
  Gd = 100;
  function sb(a, b) {
      wd.call(this);
      var c = this;
  ...
  var Qd = {
      parse: function(a, b, c, e, f) {
          for (var g = e.P,
          i = g.la(), k = Math.pow(2, 18 - i), m = g.Fc.ri(g.Qb()), n = m.lng, o = m.lat, m = g.zb(), s = m.width, v = m.height, m = [], w = 0; w < a.length; w++) {
              var y = [],
              z = a[w].l0;
              y.x = z[0];
              y.y = z[1];
          ...
          } else if ("line" === c.type) for (E = 0; E < c.ZO.length; E++) f = c.ZO[E],
          Qd.wW(b, f.ie, f.je, f.NU, f.XO, f.width, f.height, c.style, e);
          return m
      },
      ...
      Ks: function(a, b, c, e, f) {
          var g = b.Be;
          if ("lanche" !== g) if (Qd.Jx[g]) this.KK(a, b, Qd.Jx[g], e, f);
          else if (c = c.tL(g)) {
              var i = new Image;
      ...
      KK: function(a, b, c, e, f) {
          ...
          if (b.style && 62203 === s) {
              for (var v = n = m = 0; v < b.Bf.length; v++) m < b.Bf[v].width && (m = b.Bf[v].width),
              n += 20;
              m = Math.ceil(m) + 10
          }
          e && 519 === s && (o = t);
      ...
      UZ: function(a, b) {
          ...
          for (g = c.length; f < g; f++) {
              ...
              m.ui - e < i.Zf || (m.Zf > i.ui - e || m.vi - e < i.$f || m.$f > i.vi - e) || m.WJ.push(k)
          }
          f = 0;
  ...
  var Rd = ["round", "butt", "square"],
  Sd = ["miter", "round", "bevel"],
  Td = {
      daojiao: [{
          stroke: "#FF6600",
          Db: 1,
  ...
  var Wd = {
      ...
      xW: function(a, b, c, e, f) {
          c = c[0];
          if (!e && c.gp && Vd(c.gp, f, this.da)) this.FW(a, b, c, Vd(c.gp, f, this.da));
          else {
              a.beginPath();
              a.moveTo(b[0], b[1]);
              for (var f = 2,
      ...
      FW: function(a, b, c, e) {
          ...
          if (e = e[0]) if (e.yd) this.vW(a, b, e);
          else {
  ...
  he.prototype = {
      OC: function(a, b, c, e, f, g, i, k, m) {
          ...
          100);
              ...
              v[0] === Zd && Nd.drawPoly(v, s, f, g, this);
      ...
      wj: function(a, b, c, e) {
          var f = a + "-" + b + "-" + c;
          if (e) return ce[f] || (ce[f] = this.Dg(a, b, c, e)),
          ce[f];
  ...
  fa.Fp = function(a) {
      ...
      b = 0;
      for (k = this.Ve.length; b < k; b++) w = this.Ve[b],
      w.mr || (w.LB = q, delete w.LB, w.Tn = t, this.We.push(w));
      o = [];
      v = f * this.Lc;
      b = 0;
      for (k = a.length; b < k; b++) {
          ...
          C.width = f + "px",
          C.height = f + "px",
          B.Tn ? B.HF && B.HF && this.vs.push(B.HF) : (B.oH = p, B.LB = q, delete B.LB, o.push([n, s, B]));
          else {
              if (0 < this.We.length) {
                  var B = this.We.shift(),
                  E = B.getContext("2d");
      ...
      if (0 === o.length) {
          ...
          e = this.Hd.Ws(c);
          f = {};
          for (g = 0; g < this.Ww.length; g++) i = this.Ww[g],
          i = a + "_" + i[0] + "_" + i[1] + "_" + e + "_" + c,
          this.nh[i] && (f[i] = this.nh[i], this.RF && this.ow.PC.OC(this.nh[i].W0, this.nh[i].k0, this.nh[i].nm, this.nh[i].an, this.nh[i].CE, this.Hd.Nd(this.nh[i].CE), this.Hd.LD(this.nh[i].CE), this.fb.aE));
          this.nh = f
      } else {
          this.Bt = o.length;
          this.Px = t;
  ...
  function ke(a, b, c, e, f) {
      ...
      m = k.P,
      n = [],
      n = "0" === D.Au ? k.fb.tO.http: k.fb.tO.https,
              ...
              if (o !== t) {
                  ...
                  if (m.M.yk) {
                      ...
                      k.ow.PC.OC(a, f, b, c, n, k.Hd.Nd(n), k.Hd.LD(n), k.fb.aE), k.fb.wF) {
                          n = [];
                          n.l0 = [b, c, e];
                          if (a[0]) for (o = 0; o < a[0].length; o++) a[0][o][0] === Xd && n.push({
                              tM: a[0][o]
                          });
                          ...
                          f.HF = n;
                          k.vs.push(n);
                          k.Px === t && k.Bt--; (0 === k.Bt || k.Px === p) && je(k)
                      }
                  } else k.Bt--,
                  (0 === k.Bt || k.Px === p) && je(k);
                  delete window[y]
  ...
  se.getTilesUrl = function(a, b) {
      ...
      return url = this.sO[Math.abs(c + e) % this.sO.length] + this.map.Ob + "/" + this.map.Mw + "/3/lv" + (21 - b) + "/" + c + "," + e + imgType
  ...
  A.extend(Pe.prototype, {
      ...
      SV: function() {
          ...
          if (this.page < this.bg) e = 0 == this.page % this.bg ? this.page - this.bg - 1 : this.page - this.page % this.bg + 1,
          b = e + this.bg - 1;
          else {
  ...
  function Ra(a, b) {
      ...
      var f = this;
      this.eo = function() {
          this.mk === "flashRender" ? Wa.load("panoramaflash",
          function() {
              f.Vi()
          },
          p) : Wa.load("panorama",
  ...
  A.extend(Oc.prototype, {
      ha: function() {
          function a(a) {
              if (a) {
                  if (a.id != b.hw) {
                      ...
                      a.jm ? (b.Gj({
                          haveBreakId: p
                      }), Ya() && b.m.closeControl && A.U.show(b.jr)) : A.U.aa(b.jr)
                  }
              } else b.hb = b.Bl,
              b.Mb = b.Cl,
          ...
          function() {
              c.fh(Oc.ml + "qt=idata&iid=" + b.oA + "&fn=",
              function(b) {
  ...
  A.extend(Af, {
      fM: function(a, b, c, e) {
          if (!b || !c || !c.lngLat || !c.panoInstance) e();
              ...
              this.mo === l && (this.mo = new Oc(q, {
                  Ye: "api"
              }));
              var f = this;
              this.mo.fC(b,
              function(b) {
                  b ? f.mo.tj(c.lngLat, Af.sP,
                  function(b) {
                      if (b && b.id) {
                          var g = b.id,
                          m = b.zh,
      ...
      yL: function(a, b, c, e, f) {
          ...
          return (Af.Mu + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g,
          function(a, b) {
              return g[b]
          })
      }
  ...
  dg = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
  function(a) {
  ...
  function gg(a, b) {
      ...
      c.refresh();
      c.ha(Xf, window);
      c.ha(Yf); ! Uf && "none" != c.options.YO && (c.ha("DOMMouseScroll"), c.ha("mousewheel"));
  ...
  gg.prototype = {
      ...
      uQ: function() { ! this.yh && (!this.il && !(this.gm || this.zy == this.Rb.offsetWidth * this.scale && this.Vp == this.Rb.offsetHeight * this.scale)) && this.refresh()
      },
      Rv: function(a) {
          var b;
      ...
      EQ: function(a) {
          if (a.wR === p) return this.OB = a.target,
          this.gx = Date.now(),
          p;
          if (this.OB && this.gx) {
              if (600 < Date.now() - this.gx) return this.gx = this.OB = q,
              p
          } else {
          ...
          if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.WZ = p,
          a.stopPropagation(),
          a.preventDefault(),
          this.gx = this.OB = q,
          t
      ...
      $v: function(a) {
          ...
          e;
          if (this.enabled) {
              this.options.$M && this.options.$M.call(this, a); (this.options.Fi || this.options.zoom) && this.uJ(0);
              ...
              if (this.options.ay && (this.options.fl ? (c = getComputedStyle(this.Rb, q)[Lf].replace(/[^0-9\-.,]/g, "").split(","), e = +(c[12] || c[4]), c = +(c[13] || c[5])) : (e = +getComputedStyle(this.Rb, q).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Rb, q).top.replace(/[^0-9-]/g, "")), e != this.x || c != this.y)) this.options.Fi ? this.fe(cg) : eg(this.$B),
              this.Hj = [],
              this.Cr(e, c),
      ...
      YS: function(a) {
          ...
          if (this.options.zoom && Uf && 1 < a.touches.length) f = Cf.abs(a.touches[0].pageX - a.touches[1].pageX),
          g = Cf.abs(a.touches[0].pageY - a.touches[1].pageY),
          this.v0 = Cf.sqrt(f * f + g * g),
          this.il = p,
          b = 1 / this.w0 * this.v0 * this.scale,
          b < this.options.hl ? b = 0.5 * this.options.hl * Math.pow(2, b / this.options.hl) : b > this.options.mq && (b = 2 * this.options.mq * Math.pow(0.5, this.options.mq / b)),
          this.Dp = b / this.scale,
          f = this.hy - this.hy * this.Dp + this.x,
          g = this.iy - this.iy * this.Dp + this.y,
          this.Rb.style[Lf] = "translate(" + f + "px," + g + "px) scale(" + b + ")" + fg,
      ...
      iv: function(a) {
          if (! (Uf && 0 !== a.touches.length)) {
              ...
              if (b.il) e = b.scale * b.Dp,
              e = Math.max(b.options.hl, e),
              e = Math.min(b.options.mq, e),
              b.Dp = e / b.scale,
              b.scale = e,
              b.x = b.hy - b.hy * b.Dp + b.x,
              b.y = b.iy - b.iy * b.Dp + b.y,
              b.Rb.style[Nf] = "200ms",
              b.Rb.style[Lf] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + fg,
              b.il = t,
              b.refresh(),
              b.options.Kp && b.options.Kp.call(b, a);
                  ...
                  if (b.yh) {
                      if (300 > k && b.options.ay) {
                          ...
                          if (b.y > b.vf && f > b.vf || b.y < b.vd && f < b.vd) i = {
                              Ia: 0,
                              time: 0
                          }
                      }
                      ...
                      if (Uf) if (b.EK && b.options.zoom) clearTimeout(b.EK),
                      b.EK = q,
                      b.options.Lp && b.options.Lp.call(b, a),
                      b.zoom(b.zh, b.Ah, 1 == b.scale ? b.options.nW: 1),
      ...
      po: function(a) {
          ...
          if (b == this.x && c == this.y) {
              if (this.yh && (this.yh = t, this.options.fy && this.options.fy.call(this)), this.ni && this.options.Gx && ("webkit" == Ef && (this.TL.style[Qf] = "300ms"), this.TL.style.opacity = "0"), this.Gi && this.options.Gx)"webkit" == Ef && (this.RO.style[Qf] = "300ms"),
      ...
      zU: function(a) {
          ...
          if ("zoom" == b.options.YO) {
              if (e = b.scale * Math.pow(2, 1 / 3 * (e ? e / Math.abs(e) : 0)), e < b.options.hl && (e = b.options.hl), e > b.options.mq && (e = b.options.mq), e != b.scale) ! b.Uy && b.options.Lp && b.options.Lp.call(b, a),
              b.Uy++,
              b.zoom(a.pageX, a.pageY, e, 400),
              setTimeout(function() {
                  b.Uy--; ! b.Uy && b.options.Kp && b.options.Kp.call(b, a)
              },
              400)
          } else c = b.x + c,
          e = b.y + e,
      ...
      ha: function(a, b, c) { (b || this.Rb).addEventListener(a, this, !!c)
      },
      fe: function(a, b, c) { (b || this.Rb).removeEventListener(a, this, !!c)
      },
      CC: ha(2),
      refresh: function() {
          var a, b, c, e = 0;
          ...
          if ("string" == typeof this.options.lu) {
              ...
              a = 0;
              for (b = c.length; a < b; a++) e = this.jk(c[a]),
              e.left += this.YF,
              e.top += this.ZF,
      ...
      scrollTo: function(a, b, c, e) {
          ...
          a = 0;
          for (b = f.length; a < b; a++) f[a].YZ && (f[a].x = this.x - f[a].x, f[a].y = this.y - f[a].y),
          this.Hj.push({
              x: f[a].x,
              y: f[a].y,
              time: f[a].time || 0
  ...
  A.extend(hg.prototype, {
      ...
      vy: function(a, b) {
          if (b || !this.kk[this.bd] || !(this.kk[this.bd].panoId == a && 3 !== this.kk[this.bd].recoType)) {
              var c = this,
              e = this.EH(a); ! b && -1 !== e && this.kk[e] && 3 !== this.kk[e].recoType ? this.Yp(e) : this.QX(function(a) {
                  for (var b = {},
                  e, k, m = t,
                  n = [], o = 0, s = a.length; o < s; o++) e = a[o].catlog,
                  k = a[o].floor,
                  l !== e && ("" === e && l !== k ? (m = p, b[k] || (b[k] = []), b[k].push(a[o])) : (b[jg[e]] || (b[jg[e]] = []), b[jg[e]].push(a[o])));
      ...
      $i: function(a) {
          ...
          a = this.EH(this.W.Zb(), this.j2); - 1 !== a && this.Yp(a)
      },
      EX: function(a) {
          for (var b = "",
          c, e = 0,
      ...
      yX: function(a) {
          for (var b, c, e, f, g = [], i = this.kg.height, k = this.kg.width, m = 0; m < a.length; m++) b = a[m],
          recoType = b.recoType,
          e = b.panoId,
          f = b.name,
          c = b.heading,
          b = b.pitch,
          c = Af.yL(e, c, b, 198, 108),
      ...
      aQ: function() {
          ...
          A.V(this.ok, "click",
          function(b) {
              if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.bd) a.Yp(b),
              a.W.Gc(a.kk[b].panoId)
          });
          A.V(this.Xh, "mouseover",
          function(b) {
  ...
  V(Fg, {
      addCopyright: Fg.Aw,
      removeCopyright: Fg.XE,
      getCopyright: Fg.xm,
      getCopyrightCollection: Fg.CD
  });
  V(window, {
